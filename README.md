...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flake8-variables-names-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12488&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flake8-variables-names-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flake8-variables-names` can be installed with:

```
conda install flake8-variables-names
```

It is possible to list all of the versions of `flake8-variables-names` available on your platform with:
